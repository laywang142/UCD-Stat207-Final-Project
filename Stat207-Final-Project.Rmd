...
*for the spks, the row dimension is the number of neurons that were tracked during the trial and the length of spks is the number of trials. 39 is the number of time 'bins' that were used during the experiment*  
